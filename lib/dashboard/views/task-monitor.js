...
function renderTaskMonitor() {
  ...
  // Summary
  var localCount = filtered.filter(function(r){return r.s==='claude-code'||r.s==='codex-cli'||r.s==='cline'||r.s==='aider'||r.s==='gemini-cli'||r.s==='cursor'}).length;
  ...
  sortedRecords.slice(0, 100).forEach(function(r) {
    var srcLabel = recordSourceLabel(r);
